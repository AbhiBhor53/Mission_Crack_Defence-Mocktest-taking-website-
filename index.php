        ...
        <section class="header">
            <nav>
                ...
                <ul>
                   <li><a href="#">Home</a</li>
                   <li><a href="#">Shop</a</li>
                   <li><a href="blog.php#section2">Blog</a</li>
                   <li><a href="#">MyExams</a</li>
                   <li><a href="#footer">get connected</a</li>
                </ul>
                <a  class="logbtn" href="#login">REGISTER / LOGIN</a>        
                </nav>
            <div class="taglin">
                <a>Dare To Dream Big ! 
                ...
                <br>
                <br>
                <button class="tagbtn"onclick= "location.href='#login'">Buy MOCKTESTS</button>
            </div>
        </section>
        ...
        <section class="login" id="login">
            <div class="form">
                <form class="login-form" action="home.php" method="POST" >
                    ...
                    <div class="option-02">
                        <p>Not Registered? <a href="register.php#Register">Create an Account</a></p>
                    </div>
                </form>
                <!--Login form end-->
...
$_SESSION['accountName'] = $accountName;
                    ...
                    ?>
<script>
    window.location.href ='prehome.php';
</script>
<?php
                  
                   }
                  else{
                    echo '<script>alert("Logged in fail")</script>'; }
